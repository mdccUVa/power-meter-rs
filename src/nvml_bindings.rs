...
pub(super) type nvmlReturn_enum = ::std::os::raw::c_uint;

#[doc = "!< The operation was successful"]
pub(super) const NVML_SUCCESS: nvmlReturn_enum = 0;

#[doc = " Return values for NVML API calls."]
pub(super) use self::nvmlReturn_enum as nvmlReturn_t;

#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub(super) struct nvmlDevice_st {
    _unused: [u8; 0],
}
pub(super) type nvmlDevice_t = *mut nvmlDevice_st;
#[repr(transparent)]
#[derive(Clone, Debug)]
pub(super) struct NvmlDevice(pub(super) nvmlDevice_t);
...
unsafe extern "C" {
    ...
    pub(super) fn nvmlInit_v2() -> nvmlReturn_t;
}
...
unsafe extern "C" {
    ...
    pub(super) fn nvmlShutdown() -> nvmlReturn_t;
}
...
unsafe extern "C" {
    ...
    pub(super) fn nvmlDeviceGetCount_v2(deviceCount: *mut ::std::os::raw::c_uint) -> nvmlReturn_t;
}
...
unsafe extern "C" {
    ...
    pub(super) fn nvmlDeviceGetHandleByIndex_v2(
...
unsafe extern "C" {
    ...
    pub(super) fn nvmlDeviceGetTotalEnergyConsumption(
        device: nvmlDevice_t,
...
unsafe extern "C" {
    ...
    pub(super) fn nvmlDeviceGetPowerUsage(
        device: nvmlDevice_t,
